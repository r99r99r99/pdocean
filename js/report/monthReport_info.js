var myApp = angular.module('myApp', [ 'ui.grid', 'ui.grid.exporter',
		'ui.grid.pagination', 'ui.grid.resizeColumns', 'ui.grid.selection',
...
myApp
		.controller(
				'customersCtrl',
				function($scope, $sce, $http, ngDialog, $modal, $timeout) {
					...
					function zTreeOnClick(event, treeId, treeNode) {
						if (treeNode.id != null) {
							...
							if (selectNode.substring(0, 1) == "S") {
								stationid = selectNode.substring(1,
										selectNode.length);
								$scope.queryDaily();
							}
						}
